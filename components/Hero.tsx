        ...
        >
            <div className="container mx-auto text-center z-10 max-w-5xl">
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center items-center mb-6">
                    <a href="#consulta" className="inline-flex w-full sm:w-auto px-10 py-5 text-sm sm:text-base font-bold uppercase tracking-widest rounded-full bg-brand-gold hover:bg-yellow-700 text-white transition duration-300 shadow-2xl transform hover:-translate-y-1 items-center justify-center" onClick={(e) => { handleScrollClick(e); trackCTAClick('Hero CTA Principal'); }}>
                        Agendar Consulta
                    </a>
                    <a href="https://wa.me/56977646224" className="inline-flex w-full sm:w-auto px-10 py-5 text-sm sm:text-base font-bold uppercase tracking-widest rounded-full border-2 border-whatsapp-verde text-whatsapp-verde hover:bg-whatsapp-verde hover:text-white transition duration-300 shadow-2xl transform hover:-translate-y-1 items-center justify-center gap-2" onClick={() => trackWhatsAppClick('Hero WhatsApp')}>
